...
object KafkaConfig {
  ...
  val SaslServerAuthMaxReceiveSizeProp = BrokerSecurityConfigs.SASL_SERVER_AUTHN_MAX_RECEIVE_SIZE_CONFIG
  ...
  val SaslServerAuthnMaxReceiveSizeDoc = BrokerSecurityConfigs.SASL_SERVER_AUTHN_MAX_RECEIVE_SIZE_DOC
